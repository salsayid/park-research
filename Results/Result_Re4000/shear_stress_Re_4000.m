...
noise_rows     = 1000;
movavg_window  = 500;
Re_label       = '4000';      % shown in the sgtitle
% ---------------------------------------------------------------------------
...
%% Export
exportgraphics(gcf, 'wall_shear_stress_Re4000.png', 'Resolution', 300);
fprintf('Figure saved to wall_shear_stress_Re4000.png\n');

%% Save data
fid_out = fopen('wall_shear_stress_Re4000.txt', 'w');
